...
ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://www.linkpicture.com/q/2873633.jpg' : process.env.ALIVE_LOGO,
...
SESSION_ID: process.env.SESSION_ID === undefined ? 'ASTRO=03BywJQA#eUS8pz9Wwq1By-pU8uWxSyxLyIVbBnUDbihaFpvo1tg' : process.env.SESSION_ID
};
